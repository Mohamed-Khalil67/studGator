...
export const MOCK_PROGRAMS: Program[] = [
    ...
    {
        id: 4,
        programName: 'Bachelor in Politics and Government',
    ...
    {
        id: 7,
        programName: 'Bachelor in Digital Marketing',
    ...
    {
        id: 8,
        programName: 'Master in Architecture',
        schoolName: 'École Spéciale d\'Architecture',
        logoUrl: 'https://ui-avatars.com/api/?name=ESA&background=8A4B08&color=fff&bold=true',
        country: 'France',
        tuition: 9800,
        tuitionPeriod: '1stYear',
    ...
    {
        id: 14,
        programName: 'Master in International Law',
        schoolName: 'Universidad Carlos III de Madrid',
        logoUrl: 'https://ui-avatars.com/api/?name=UC3M&background=00366D&color=fff&bold=true',
        country: 'Spain',
        tuition: 5400,
        tuitionPeriod: '1stYear',
        category: 'Politics & Social Sciences'
